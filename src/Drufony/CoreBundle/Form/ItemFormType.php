...
{
    const MIN_DATE_SHOW_IN_CALENDAR = '2 years';
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $requiredFields = unserialize(FIELDS_REQUIRED_ITEM);
        ...
        $builder
            ...
            ->add('addHierarchy', 'button', array(
                ...
                'attr' => array('class' => 'btn add-btn', 'data-target' => 'itemForm_parents')
            ))
            ...
            ->add('addImg', 'button', array('label' => t('+ Add image'), 'attr' => array('class' => 'btn add-img-btn', 'data-target' => 'itemForm_images')))
            ...
            ->add('addAttach', 'button', array('label' => t('+ Add attachment'), 'attr' => array('class' => 'btn add-attach-btn', 'data-target' => 'itemForm_attachments')))
            ...
            ->add('addVideo', 'button', array('label' => t('+ Add Video'), 'attr' => array('class' => 'btn add-attach-btn', 'data-target' => 'itemForm_videos')))
            ...
            ->add('addLink', 'button', array('label' => t('+ Add link'), 'attr' => array('class' => 'btn add-link-btn', 'data-target' => 'itemForm_links')))
            ...
            if (!in_array('tags', unserialize(FIELDS_ITEM_HIDE))) {
                $index = 1;
            ...
            if ($options['data']->isShowInCalendar()) {
                $dateMin = new \DateTime();
                $interval = \DateInterval::createFromDateString(self::MIN_DATE_SHOW_IN_CALENDAR);
                $dateMin = $dateMin->sub($interval);
                $builder->add('dateCalendar', 'datetime', array(
                ...
                $builder->add('dateCalendar', 'hidden', array(
                ));
            }
            $builder->add('showInCalendar', 'hidden', array(
                'data' => $options['data']->isShowInCalendar() ? 1 : 0,
            ))
            ...
            ContentUtils::addLocationFormFields(Content::TYPE_ITEM, $builder);
        ...
        foreach (unserialize(FIELDS_ITEM_HIDE) as $toHide) {
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Drufony\CoreBundle\Model\Item',
        ));
    }
